...
-(void)setSubViews:(SelectView *)selectView
{
    ...
    [self.leftBtn setTitle:@"录取" forState:UIControlStateNormal];
...
//    lineView.backgroundColor = RGBACOLOR(200, 200, 200, 0.8) ;
    ...
    UIImageView *bottonLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, 45, SCREEN_W/2, 2)];
